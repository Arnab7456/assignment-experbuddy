      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        <div className="flex items-center gap-8">
          <Link href="/" className="flex items-center">
            ...
            <span className="ml-2 text-2xl font-bold text-purple-600">BUDDY</span>
          </Link>
        </div>
        <div className="flex items-center gap-8 ml-auto mr-10">
          <nav className="hidden md:flex items-center space-x-8">
            <Link href="/find-tutor" className="text-base font-medium text-gray-900 hover:text-purple-600">
              Find Tutor
            </Link>
            <Link href="/homework" className="text-[#640D51] font-medium  hover:text-purple-600">
              Homework
            </Link>
          </nav>
          <div className="flex items-center rounded-md border border-orange-300 bg-orange-50 px-3 py-1">
            ...
            <span className="ml-1 text-sm font-medium text-orange-500">0 USD</span>
          </div>
          <Button
            variant="outline"
...
<path d="M16 17.4301H12L7.54999 20.39C6.88999 20.83 6 20.3601 6 19.5601V17.4301C3 17.4301 1 15.4301 1 12.4301V6.42999C1 3.42999 3 1.42999 6 1.42999H16C19 1.42999 21 3.42999 21 6.42999V12.4301C21 15.4301 19 17.4301 16 17.4301Z" stroke="#16192C" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
